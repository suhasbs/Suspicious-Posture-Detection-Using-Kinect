...
class NotificationHub:
    ...
    def generate_sas_token(self):
        ...
        print target_uri
        # my_uri = urllib.pathname2url(target_uri).lower()
        # my_uri = urlencode(target_uri, '').lower()
        my_uri = 'https%3a%2f%2fmmvmmv.servicebus.windows.net%2fmmv'
        print (my_uri)
        
        expiry = str(self.get_expiry())
        to_sign = my_uri + '\n' + expiry
        signature = urllib.pathname2url(self.sign_string(to_sign))
        print signature
        # exit(0)
